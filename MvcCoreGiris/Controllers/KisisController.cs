...
namespace MvcCoreGiris.Controllers
{
    public class KisisController : Controller
    {
        ...
        public KisisController(OkulContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,KisiAd")] Kisi kisi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KisiAd")] Kisi kisi)
        {
            if (id != kisi.Id)
            {
                return NotFound();
